  ...
  return (
    <section className="row container mx-auto align-items-center justify-content-center full-h">
      ...
      <form className="col-12 col-md-5 pb-3 pb-md-0">
        ...
        <input id="email" type="email" className="form-control" placeholder="Ej: mail@mail.com" />
        <br />
        <label htmlFor="message" className="small">Mensaje</label>
        <textarea id="message" className="form-control" placeholder="Tu mensaje" rows="5"></textarea>
